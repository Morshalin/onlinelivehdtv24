...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- Main CSS-->
        <link rel="stylesheet" href="{{ check_https() }}://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.6.3/css/bootstrap-select.min.css" />
        <link rel="stylesheet" type="text/css" href="{{asset('backend/css/main.css')}}">
        <!-- Font-icon css-->
        <link rel="stylesheet" href="{{asset('backend/css/tagsinput.css')}}">
        <link rel="stylesheet" type="text/css" href="{{ check_https() }}://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <body class="app sidebar-mini rtl {{Request::is('admin/order/create*') ? 'sidenav-toggled':''}}" >
        <!-- Navbar-->
        ...
        <script src="{{ check_https() }}://cdn.ckeditor.com/4.13.1/standard/ckeditor.js"></script>
