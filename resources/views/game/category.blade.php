...
@extends('game.layouts.app', ['banner_image' =>   $banner_image])
@section('title')
<title> Sports |{{$banner_image->cat_name}}</title>
@endsection
@section('meta')
...
<div class="couter-and-upcomming pt-100 md-pt-80 sm-pt-30 mb-30">
    <div class="container">
...
<div class="rs-match-result style1 nav-style pb-100 md-pb-80 sm-pb-40">
    <div class="container">
...
<div class="rs-lates-news sec-bg pt-91 pb-100 md-pt-50 md-pb-50">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 md-mb-30" {{!isset($banner_news)?'style="display:none"':'style="display:none"initial'}}>
                <div class="latest-news-grid">
                    <div class="news-img">
                        <a href="{{route('newsdetails',$banner_news->title_slug)}}"><img src="{{asset('uploads')}}/{{$banner_news->image}}" alt="{{isset($banner_news->alt_tag)?$banner_news->alt_tag:""}}"></a>
                    </div>
                    <div class="news-info">
                        <div class="news-date">
            ...
            @if ($news_latest->count() > 0)
                ...
                @foreach ($news_latest as $news_item)
                    <div class="latest-news-grid small-grid mb-3">
                        <div class="news-img">
                            <a href="{{route('newsdetails',$news_item->title_slug)}}"><img src="{{asset('uploads')}}/{{$news_item->image}}" alt="{{isset($news_item->alt_tag)?$banner_news->alt_tag:""}}"></a>
                        </div>
                        <div class="news-info">
                            <div class="news-date">
                                <i class="fa fa-calendar-check-o"></i>
...
<script>
    ...
    if(countdown_first.length){
        ...
        var countDownDate = new Date("{{isset($end_date)?$end_date:28-8-2019}}").getTime();
        var start_date = new Date("{{isset($start_date)?$start_date:28-8-2019}}").getTime();
