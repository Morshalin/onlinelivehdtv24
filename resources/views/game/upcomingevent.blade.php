...
@section('title')
<title> Sports | Upcoming Events </title>
@endsection
...
<div class="rs-lates-news sec-bg ">
    ...
    <div class="container">
        <div class="rs-blog modify pt-50 md-pt-80 sm-pt-30">
            <div class="container">
                <div class="pb-100 md-pb-74 sm-pb-0">
                    <div class="row">
                        <div class="col-lg-12 md-mb-50">
                            <div class="row">
                                @if ($upcoming_match->count() > 0)
                                    @foreach ($upcoming_match as $match_upcoming_item)
                            ...
                            <div class="row">
                                <div class="col-sm-12 mx-auto text-ceter" align="center"> 
                                    {{ $upcoming_match->links() }}
                                </div>
                            </div>
                        </div>
                    </div>
