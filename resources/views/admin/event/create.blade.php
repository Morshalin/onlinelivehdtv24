            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="cover_image_alt" id="cover_image_alt">
                    </div>
                </div>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="thumbnail_image_alt" id="thumbnail_image_alt">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" readonly="" autocomplete="off" class="form-control date" name="match_start_date" id="match_start_date">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="event_type" name="event_type" type="text">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="event_country" name="event_country" type="text">
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input class="form-control"  id="total_event" name="total_event" type="text">
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <textarea name="schema_tag" id="schema_tag" cols="30" rows="10" class="form-control"></textarea>
                    </div>
                </div>
