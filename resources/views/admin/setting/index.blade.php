              ...
              <div class="tab-content">
                <div id="home" class="container tab-pane active">
                   <div class="row">
                     ...
                     <div class="col-md-6">
                       {{ Form::label(_lang('Fax'), _lang('Fax') , ['class' => 'col-form-label ']) }}
                       {{ Form::text('fax',get_option('fax'), ['class' => 'form-control', 'placeholder' => _lang('Fax Address')]) }}
                     </div>
                     <div class="col-md-6">
                ...
                <div id="menu1" class="container tab-pane fade">
                 <div class="row">
                   ...
                   <div class="col-md-6">
                     {{ Form::label('logo Two', _lang('logo Two') , ['class' => 'col-form-label']) }}
                     <input type="file" name="logo2">
                     @if(get_option('logo2'))
                        <input type="hidden" name="oldLogo2" value="{{get_option('logo2')}}">
                      @endif
