    ...
    <form action="{{route('admin.category.update',$model->id)}}" method="post" id="content_form">
      ...
      <div class="row">
        <div class="col-sm-4">
          ...
          <input class="form-control" value="{{$model->cat_name}}" id="cat_name" name="cat_name" type="text" placeholder="Category Name">
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            <label for="cat_slug_name">Category Slug</label>
            <input class="form-control"  value="{{$model->cat_slug_name}}"  id="cat_slug_name" name="cat_slug_name" type="text">
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
