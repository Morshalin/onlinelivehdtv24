          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="alt_tag" id="alt_tag" value="{{$model->alt_tag}}">
              </div>
            </div>
            <div class="col-sm-12">
              <div class="form-group">
            ...
            <div class="row">
                <div class=" col-sm-6 toggle lg">
                    <label>
                        <input type="checkbox" name="status" checked="" id="status"><span class="button-indecator"></span>
                    </label>
                </div>
                <div class="col-sm-6 toggle lg">
